...
#define LOG_TAG "vendor.lineage.biometrics.fingerprint.inscreen@1.1-service.jd20"
...
using vendor::lineage::biometrics::fingerprint::inscreen::implementation::FingerprintInscreen;
